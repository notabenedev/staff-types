...
@section('header-title', "{$name->title}")
...
@section('admin')
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route("admin.staff-param-names.update", ["name" => $name]) }}" method="post">
                    @csrf
                    @method("put")
                    ...
                    <div class="form-group">
                        ...
                        @include('staff-types::admin.staff-param-names.includes.value-types', ['name' => $name, 'old' => old('value_type')])
                        @error("value_type")
                        <div class="invalid-feedback" role="alert">
                            {{ $message }}
                        </div>
                    ...
                    <div class="my-3">
                        ...
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control-input"
                                   type="checkbox"
                                   {{ (old('expected_at') || $name->expected_at) ? "checked" : "" }}
                                   value="1"
                                   id="expectedBtn"
                                   name="expected-btn">
